...
export const Box = styled.div`
    ...
    border: ${props =>
      props.border || props.debug ? '1px solid black' : 'none'}
    margin: ${props =>
      props.margin && !props.bottom && !props.top ? props.margin : 0}
...
export const FormField = styled.input`
    -webkit-appearance: ${props =>
      props.type === 'checkbox' ? props.type : 'none'};
    width: ${props => (props.width ? props.width : 'auto')}
    height: ${props => (props.height ? props.height : 'auto')}
    flex-grow: ${props => (props.grow ? props.grow : 0)};
    align-self: ${props => (props.alignSelf ? props.alignSelf : 'auto')};
    ...
    border-bottom:${props => (props.borderBottom ? '1px solid #ccc' : 'none')}
...
export const Button = styled.button.attrs({
  disabled: props => props.disabled
    ...
    background-color: ${props =>
      props.disabled ? 'white' : props.primary ? '#4caf50' : 'white'};
    color: ${props =>
      props.disabled ? 'ligthgrey' : props.primary ? 'white' : '#4caf50'};
     margin-top: ${props => (props.top ? props.top : 0)};
